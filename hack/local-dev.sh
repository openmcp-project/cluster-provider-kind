...
SERVICE_PROVIDER_CROSSPLANE_VERSION=${SERVICE_PROVIDER_CROSSPLANE_VERSION:-v1.4.0}
...
PLATFORM_SERVICE_GATEWAY_VERSION=${PLATFORM_SERVICE_GATEWAY_VERSION:-v0.2.3}
